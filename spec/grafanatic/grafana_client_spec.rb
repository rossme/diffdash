...
RSpec.describe Grafanatic::GrafanaClient do
  ...
  describe "#initialize" do
    ...
    it "raises error when GRAFANA_URL is not set" do
      ...
      expect { described_class.new }.to raise_error(Grafanatic::Error, /GRAFANA_URL not set/)
    end
    ...
    it "raises error when GRAFANA_TOKEN is not set" do
      ...
      expect { described_class.new }.to raise_error(Grafanatic::Error, /GRAFANA_TOKEN not set/)
    end
  end
    ...
    context "when Grafana returns non-200" do
      ...
      it "raises ConnectionError" do
        expect { client.health_check! }.to raise_error(
          Grafanatic::GrafanaClient::ConnectionError,
